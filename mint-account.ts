...
const main = async () => {
    ...
    const tokenMintAccount = new web3.PublicKey( "6qNJHtgiqKLqAdYVGbBk25dCaqp444sUYufgiwzLxkqJ")
    const tokenAccount = new web3.PublicKey( "C1gGp6VKWeMN6hy2KcP1Tc5J6X2DNUoLaNhfafXTwUyY")
